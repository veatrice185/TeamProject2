...
/**
 * Servlet implementation class UnIssuedChange
 */
//우산 반납하기를 선택하였을때 작동하는 서블릿 페이지 입니다.
//태블릿의 안드로이드에서 우산 반납하기를 선택하였을 경우에 작동합니다.
//데이터베이스의 사용자 테이블에서 해당 nfc id를 가진 사람의 issued값을 0으로 변경시켜줍니다.
@WebServlet(urlPatterns = { "/UnIssuedChange" }, initParams = {
...
public class UnIssuedChange extends HttpServlet {
	...
	try{
		...
		userDataMan.unissued(nfctagid);
		userDataMan.returnTime(customerid);
		out.println("<html>");
		out.println("<head>");
