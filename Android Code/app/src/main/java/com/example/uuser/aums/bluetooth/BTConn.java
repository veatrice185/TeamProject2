package com.example.uuser.aums.bluetooth;
...
import com.example.uuser.aums.ArduinoAdapter;
import com.example.uuser.aums.R;
...
public class BTConn implements BTCommHandler.Listener{
    private final static String TAG = "BTConn";
//    private ArrayList<String> chatList = null;
//    private final static String CHATLIST_KEY = "coo.BluetoothActivity.chatList";
...
//    }
    ...
    public void connect(final BluetoothDevice device) {
        ...
        Log.e(TAG, "connect Thread start");
    }
...
//        inputText.getText().clear();
        ...
        Log.e(TAG, "sending Text~"+text);
        if(text.equals("0"))
            ArduinoAdapter.setIsTagged(false);
    }

    public ReaderThread reader = null;
        ...
        public void run() {
            try {
                while (true) {
                    ...
                    Log.e("rcv:", text);
                    handler.sendMessage(message);
                    ArduinoAdapter.setNFCtagID(text);
                    ArduinoAdapter.setIsTagged(true);
                }
        ...
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    socket = servSock.accept(SERVER_TIMEOUT_SEC * 1000);
