...
Servo myservo1;
Servo myservo2;
Servo myservo3;//Connect HC-06 TX,RX
...
void bluetooth(uint32_t cardid)
{
   /*if (BTSerial.available()){
    long int data = BTSerial.parseInt();
    Serial.println(data);
    //Serial.write(data);
  }*/
  
  Serial.println("bluetooth ok");
  BTSerial.println(cardid);
  //int check = BTSerial.parseInt();
  //return check;
  //BTSerial.write(cardid);
  }
...
void choice()
{
  if (BTSerial.available())
  {
    ...
    long int num = BTSerial.parseInt();
    if(num == 1)
    {
      //Serial.write(a);
     // int servo_value = 90;
